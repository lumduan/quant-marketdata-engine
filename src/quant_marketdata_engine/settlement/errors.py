...
class SettlementError(MarketDataEngineError):
    """Base for settlement-side problems."""


class SettlementFetchError(SettlementError):
    """A TFEX settlement fetch (via ``settfex``) failed.
